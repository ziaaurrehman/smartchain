...
import singleDetails from "assets/img/blog/single-details-img.jpg"
import blogImage from "assets/img/blog/blog1.jpg"
import blogImage2 from "assets/img/blog/blog2.jpg"
import author from "assets/img/blog/author_img.jpg"
import author2 from "assets/img/blog/author2.jpg"
import author3 from "assets/img/blog/author3.jpg"
				...
				<div className="row">
					<div className="col-xl-8 col-12 pe-xl-5">
						<div className="blog-content">
							...
							<img src={blogImage} className="me-lg-3" alt="" />
							...
							<div className="comments-list">
								<div className="single-comment">
									<div
										...
										style={{ backgroundImage: `url(${author2})` }}
									></div>
								...
								<div className="single-comment">
									<div
										className="user-img bg-cover"
										style={{ backgroundImage: `url(${author3})` }}
									></div>
									<div className="comment-data">
										<h6>Salman Ahmed</h6>
